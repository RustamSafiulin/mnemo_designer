...
public:
    ...
    QString getInternalElementType() const; //неизменяемое поле

    void setScreenLink(const QString &);
    QString getScreenLink() const;
...
protected:
    /** Свойства, влияющие на поведение и внешний вид*/
    QString elementId;
    QString screenLink;
    QString messageType;
    ...
    /** Внутренние свойства для удобства использования*/
    QIcon elementIcon;
