    ...
    QMainWindow(parent)
{
    ...
    setWindowTitle(trUtf8("Предварительный просмотр"));
    createActions();
}

void PreviewWindow::createActions() {

    actionClose = new QAction(QIcon(":/images/fullscreen.png"),trUtf8("Выйти из предварительного просмотра (ESC)"),
                              this);
    actionPrint = new QAction(QIcon(":/images/fileprint.png"),trUtf8("Печать"),this);
